		...
		<div class="container">
					...
					<div class="container">
						...
						<div class="nav-collapse">
							<ul class="nav">
								...
								<li class="dropdown">
									<a href="helpUI.jsp" class="dropdown-toggle" data-toggle="dropdown">学习笔记 <b class="caret"></b></a>
			...
			<div class="row">
				...
				<div class="span9">
					...
					<ul class="breadcrumb">
						<li>
							<a href="helpUI.jsp">Help</a> <span class="divider">/</span>
						</li>
						<li>
							<a href="#">Projects</a> <span class="divider">/</span>
						</li>
						<li class="active">
							Creating a new Project
						</li>
					...
					<div class="row">
						<div class="span7">
							...
							<p><img src="img/tmp/670x240.gif" alt="Sample Graphic" /></p>
